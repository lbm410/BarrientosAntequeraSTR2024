...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#0820bbb8#;
   ...
   u00121 : constant Version_32 := 16#03d5edb6#;
   pragma Export (C, u00121, "ejercicio1B");
   u00122 : constant Version_32 := 16#17aff749#;
   pragma Export (C, u00122, "ejercicio1S");
   ...
   u00139 : constant Version_32 := 16#48c2a7b9#;
   pragma Export (C, u00139, "matriz_transpuestaB");
   u00140 : constant Version_32 := 16#fdb46710#;
   pragma Export (C, u00140, "matriz_transpuestaS");
   ...
   --  ejercicio1%s
   --  ejercicio1%b
   --  matriz_transpuesta%s
   --  matriz_transpuesta%b
   --  main%b
