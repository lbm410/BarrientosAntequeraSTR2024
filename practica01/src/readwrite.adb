    ...
    begin
        ...
        while not End_Of_File(Input_File) loop
            ...
            if Tt_val > 98.0 then
                ...
                Put_Line("ALARMA! Temperatura a la salida del campo solar mayor de 98ºC en la iteracion " & Float'Image(K));
                -- Escribir en el archivo de registro de alarmas
                Put_Line(Alarm_Log, "ALARMA! Temperatura a la salida del campo solar mayor de 98ºC en la iteracion " & Float'Image(K));
            end if;
